  ...
  <div>
    ...
    <li class="flex-item">
      <a href="https://stcrida.co.uk/cs.php" target="_blank">
        <img src="${h}" class="logo green" alt="Creed Churchyard logo" />
      </a>
...
`;document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector("#search-container");t&&(t.appendChild(l),t.appendChild(o),t.style.marginBottom="1em")});
