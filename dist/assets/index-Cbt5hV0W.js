...
<h2>What's on</h2>
    ...
    <li class="flex-item">
      <a href="https://www.achurchnearyou.com/search/?acny_search_place=Grampound%2C+Truro%2C+UK&lat=50.2992589&lon=-4.8984499&place=Grampound%2C+Truro+TR2%2C+UK&postcode=TR2&text=" target="_blank">
        <img src="${y}" class="logo" alt="A Church Near You logo" />
      </a>
...
<h2>Photos and more</h2>
    ...
    <li class="flex-item">
      <a href="https://www.geograph.org.uk/mapper/combined.php#15/50.3010/-4.9012" target="_blank">
        <img src="${C}" class="logo vanilla" alt="Geograph logo" />
      </a>
    ...
    <li class="flex-item">
      <a href="https://stcrida.co.uk/cs.php" target="_blank">
        <img src="${v}" class="logo green" alt="Creed Churchyard logo" />
      </a>
...
<h2>Environment</h2>
    ...
    <li class="flex-item">
      <a href="https://www.floodmapper.co.uk/data-explorer/search-sewage-report/1bfb1dc2-aaf8-11ee-baa2-0242ac140003/Grampound" target="_blank">
        <div id="water-quality-traffic-light">
          ${p}
          <img src="${_}" class="logo" alt="Sewage discharges logo" />
        </div>
      </a>
    ...
    <li class="flex-item">
      <a href="https://map.purpleair.com/air-quality-standards-us-epa-aqi?opt=%2F1%2Flp%2Fa10%2Fp604800%2FcC0#8.63/50.2076/-5.023" target="_blank">
        <img src="${w}" class="logo" alt="Air Quality, PurpleAir logo" />
      </a>
      <p>${A}</p>
...
<h2>More info</h2>
    ...
    <li class="flex-item">
      <a href="https://github.com/rdjenkins/gdt/discussions" target="_blank">
        <img src="${b}" class="logo" alt="GitHub Logo" />
      </a>
...
`;document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector("#search-container");e&&(e.appendChild(s),e.appendChild(i),e.style.marginBottom="1em")});document.addEventListener("DOMContentLoaded",()=>{L().then(e=>{p=e;const t=document.querySelector("#water-quality-traffic-light");t&&(t.innerHTML=p+"<div>Get more detail on floodmapper ↗</div>")})});async function d(e,t=""){let l="";return l=await(await fetch("https://deanjenkins.me/repack.php",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`lg=${encodeURIComponent(e)}&u=${encodeURIComponent(t)}`})).text(),console.log("GDT Logging:",l),l}document.addEventListener("DOMContentLoaded",()=>{const e=document.createElement("script");e.src="https://www.purpleair.com/pa.widget.js?key=DX82CA29U5Z4C6HO&module=US_EPA_AQI&conversion=C0&average=10&layer=US_EPA_AQI&container=PurpleAirWidget_262781_module_US_EPA_AQI_conversion_C0_average_10_layer_US_EPA_AQI",document.body.appendChild(e)});document.addEventListener("click",e=>{const t=e.target,l=t.closest("a");l&&l instanceof HTMLAnchorElement&&d("Hyperlink clicked: ",l.href),t.id==="search-button"&&d("Search button clicked: "+(s.value||"").trim())});document.addEventListener("DOMContentLoaded",()=>{const e="PurpleAirWidget_262781_module_US_EPA_AQI_conversion_C0_average_10_layer_US_EPA_AQI";let t=!1;const l=new MutationObserver(()=>{const o=document.getElementById(e);if(o){let r=Array.from(o.querySelectorAll("span")).find(n=>{const a=n.textContent?.trim()||"",u=!isNaN(parseFloat(a)),g=window.getComputedStyle(n).fontSize;return u&&parseFloat(g)>=60});if(r){console.log("PurpleAir Pm2.5 span found");const n=parseFloat(r.innerHTML);if(!isNaN(n)&&n<50){const a=document.createElement("span");a.textContent=r.textContent,a.style.background="green",a.style.color="white",a.style.borderRadius="1000px",a.style.padding="0.5em 0.5em",o.innerHTML="",o.appendChild(a)}if(!isNaN(n)&&n>=50&&n<100){const a=document.createElement("span");a.textContent=r.textContent,a.style.background="yellow",a.style.color="white",a.style.borderRadius="1000px",a.style.padding="0.5em 0.5em",o.innerHTML="",o.appendChild(a)}t===!1&&(d(`Nearest PurpleAir sensor Pm2.5 value: ${n}`),t=!0)}}}),c=document.getElementById(e);c?l.observe(c,{childList:!0,subtree:!0}):console.error("PurpleAir widget not found.")});
