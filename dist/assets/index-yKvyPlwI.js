(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&c(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function c(e){if(e.ep)return;e.ep=!0;const a=s(e);fetch(e.href,a)}})();const i="/gdt/OpenStreetMap-logo-with-text.svg",p="/gdt/gwchp-logo-coloured-600x600.png",d="/gdt/calendar.svg",g="/gdt/acny.png",u="/gdt/PurpleAir-Cornwall-Map.png",h="/gdt/Water-quality-sewage.png",m="/gdt/creed-churchyard.png",f="/gdt/geograph-logo.svg",l=document.createElement("input");l.type="text";l.placeholder="Find an address or place...";const r=document.createElement("button");r.textContent="Search";r.onclick=()=>{const o=`https://www.openstreetmap.org/search?query=${encodeURIComponent(`${l.value} "Grampound with Creed"`)}&zoom=19&minlon=-4.903727173805238&minlat=50.298594007719345&maxlon=-4.900551438331605&maxlat=50.29984131703836#map=17/50.298894/-4.900718`;window.open(o,"_blank")};l.addEventListener("keydown",t=>{t.key==="Enter"&&typeof r.onclick=="function"&&r.click()});document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector("#app");if(t){const o=document.createElement("div");o.style.marginBottom="1em",o.appendChild(l),o.appendChild(r),t.prepend(o)}});document.querySelector("#app").innerHTML=`
  <div>
    <h1>Grampound</h1>
    <p class="subtitle">
