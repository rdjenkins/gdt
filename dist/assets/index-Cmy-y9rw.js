(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))c(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&c(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const u="/gdt/OpenStreetMap-logo-with-text.svg",g="/gdt/gwchp-logo-coloured-600x600.png",h="/gdt/calendar.svg",m="/gdt/acny.png",f="/gdt/PurpleAir-Cornwall-Map.png",y="/gdt/Water-quality-sewage.png",w="/gdt/creed-churchyard.png",_="/gdt/geograph-logo.svg",v="/gdt/github-mark.svg";let C="<div id='PurpleAirWidget_262781_module_US_EPA_AQI_conversion_C0_average_10_layer_US_EPA_AQI'>Loading nearest sensor ...</div>";async function b(){return await(await fetch("https://deanjenkins.me/repack.php?id=grampoundwaterDOM")).text()}let p="";const s=document.createElement("input");s.type="text";s.placeholder="Find an address or place...";const i=document.createElement("button");i.textContent="Search";i.id="search-button";i.onclick=()=>{const t=`https://www.openstreetmap.org/search?query=${encodeURIComponent(`${s.value} "Grampound with Creed"`)}&zoom=19&minlon=-4.903727173805238&minlat=50.298594007719345&maxlon=-4.900551438331605&maxlat=50.29984131703836#map=17/50.298894/-4.900718`;window.open(t,"_blank")};s.addEventListener("keydown",e=>{e.key==="Enter"&&typeof i.onclick=="function"&&i.click()});document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector("#app");if(e){const t=document.createElement("div");t.style.marginBottom="1em",t.appendChild(s),t.appendChild(i),e.prepend(t)}});document.querySelector("#app").innerHTML=`
  <div>
    <h1>Grampound</h1>
    <p class="subtitle">
...
`;document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector("#search-container");e&&(e.appendChild(s),e.appendChild(i),e.style.marginBottom="1em")});document.addEventListener("DOMContentLoaded",()=>{b().then(e=>{p=e;const t=document.querySelector("#water-quality-traffic-light");t&&(t.innerHTML=p+"<div>Get more detail on floodmapper ↗</div>")})});async function d(e,t=""){let n="";return n=await(await fetch("https://deanjenkins.me/repack.php",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:`lg=${encodeURIComponent(e)}&u=${encodeURIComponent(t)}`})).text(),n}document.addEventListener("DOMContentLoaded",()=>{const e=document.createElement("script");e.src="https://www.purpleair.com/pa.widget.js?key=DX82CA29U5Z4C6HO&module=US_EPA_AQI&conversion=C0&average=10&layer=US_EPA_AQI&container=PurpleAirWidget_262781_module_US_EPA_AQI_conversion_C0_average_10_layer_US_EPA_AQI",document.body.appendChild(e)});document.addEventListener("click",e=>{const t=e.target,n=t.closest("a");n&&n instanceof HTMLAnchorElement&&d("Hyperlink clicked: ",n.href),t.id==="search-button"&&d("Search button clicked: "+(s.value||"").trim())});document.addEventListener("DOMContentLoaded",()=>{const e="PurpleAirWidget_262781_module_US_EPA_AQI_conversion_C0_average_10_layer_US_EPA_AQI";let t=!1;const n=new MutationObserver(()=>{const r=document.getElementById(e);if(r){const o=r.querySelector('span[style="display: inline-block; font-size: 80px;"]');if(o){const l=parseFloat(o.innerHTML);if(!isNaN(l)&&l<50){const a=document.createElement("span");a.textContent=o.textContent,a.style.background="green",a.style.color="white",a.style.borderRadius="1000px",a.style.padding="0.5em 0.5em",r.innerHTML="",r.appendChild(a)}if(!isNaN(l)&&l>=50&&l<100){const a=document.createElement("span");a.textContent=o.textContent,a.style.background="yellow",a.style.color="white",a.style.borderRadius="1000px",a.style.padding="0.5em 0.5em",r.innerHTML="",r.appendChild(a)}t===!1&&(d(`Nearest PurpleAir sensor Pm2.5 value: ${l}`),t=!0)}}}),c=document.getElementById(e);c&&n.observe(c,{childList:!0,subtree:!0})});
