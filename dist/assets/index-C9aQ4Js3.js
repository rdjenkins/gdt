(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&c(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function c(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();const p="/gdt/OpenStreetMap-logo-with-text.svg",d="/gdt/gwchp-logo-coloured-600x600.png",g="/gdt/calendar.svg",u="/gdt/acny.png",h="/gdt/PurpleAir-Cornwall-Map.png",m="/gdt/Water-quality-sewage.png",f="/gdt/creed-churchyard.png",y="/gdt/geograph-logo.svg",w="/gdt/github-mark.svg";async function v(){return await(await fetch("https://deanjenkins.me/repack.php?id=grampoundwaterDOM")).text()}let i="";const l=document.createElement("input");l.type="text";l.placeholder="Find an address or place...";const o=document.createElement("button");o.textContent="Search";o.onclick=()=>{const a=`https://www.openstreetmap.org/search?query=${encodeURIComponent(`${l.value} "Grampound with Creed"`)}&zoom=19&minlon=-4.903727173805238&minlat=50.298594007719345&maxlon=-4.900551438331605&maxlat=50.29984131703836#map=17/50.298894/-4.900718`;window.open(a,"_blank")};l.addEventListener("keydown",t=>{t.key==="Enter"&&typeof o.onclick=="function"&&o.click()});document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector("#app");if(t){const a=document.createElement("div");a.style.marginBottom="1em",a.appendChild(l),a.appendChild(o),t.prepend(a)}});document.querySelector("#app").innerHTML=`
  <div>
    <h1>Grampound</h1>
    <p class="subtitle">
...
`;document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector("#search-container");t&&(t.appendChild(l),t.appendChild(o),t.style.marginBottom="1em")});document.addEventListener("DOMContentLoaded",()=>{v().then(t=>{i=t;const a=document.querySelector("#water-quality-traffic-light");a&&(a.innerHTML=i+"<div>Get more detail on floodmapper ↗</div>")})});
